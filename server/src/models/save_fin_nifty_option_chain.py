class FinNiftyOptionChain:
    ...
    def save(self, cur):
        insert_query = """INSERT INTO fin_nifty_option_chain (instrument_token, exchange_token, tradingsymbol, name, last_price, expiry, strike, tick_size, lot_size, instrument_type, segment, exchange) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT (instrument_token) DO NOTHING;"""
