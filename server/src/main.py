...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting VCP Trader API server with optimized scheduler...")
    ...
    try:
        ...
        # Start optimized scheduler
        from controllers import get_scheduler
...
def cleanup_resources():
    ...
    try:
        risk_calculation_executor.shutdown(wait=True)
